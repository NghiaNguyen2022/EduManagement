...
--
-- CANH BAO:
-- Script nay XOA TOAN BO database SchoolCenter va tao lai tu dau.
-- Chi dung khi chua co du lieu nghiep vu that.
-- Hay backup truoc khi chay.
-- ============================================================

SET FOREIGN_KEY_CHECKS = 0;

DROP DATABASE IF EXISTS SchoolCenter;

CREATE DATABASE SchoolCenter
