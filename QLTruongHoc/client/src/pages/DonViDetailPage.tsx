...
import { FileUploadField, SelectField, TextField } from "../components/form";
...
function toEditForm(item: DonViItem): EditForm {
      return {
            ...
            maGiayPhep: item.maGiayPhep ?? "",
            giayPhepUrl: item.giayPhepUrl ?? "",
      };
}
                  ...
                  <SectionCard title="Thông tin đơn vị">
                        <form className="user-create-form" onSubmit={handleSave}>
                              ...
                              <TextField
                                    ...
                                    disabled={!canManage}
                                    onChange={(value) => updateForm({ nguoiDaiDien: value })}
                              />
                              ...
                              <TextField
                                    ...
                                    value={form.maSoThue}
                                    disabled={!canManage}
                                    onChange={(value) => updateForm({ maSoThue: value })}
                              />
                              ...
                              <TextField
                                    ...
                                    disabled={!canManage}
                                    onChange={(value) => updateForm({ maGiayPhep: value })}
                              />
                              ...
                              {canManage ? (
                                    <FileUploadField
                                          ...
                                          accept="image/*"
                                          onChange={(url) => updateForm({ hinhAnhUrl: url ?? "" })}
                                    />
                              ) : null}
                              ...
                              {canManage ? (
                                    <FileUploadField
                                          label="Giấy phép (tệp)"
                                          value={form.giayPhepUrl || null}
                                          accept="image/*,application/pdf"
                                          previewAsImage={false}
                                          helpText="Ảnh chụp hoặc PDF giấy phép hoạt động."
                                          onChange={(url) => updateForm({ giayPhepUrl: url ?? "" })}
                                    />
                              ) : null}
